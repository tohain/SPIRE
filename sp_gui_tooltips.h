...
class tooltips {
 public:
  tooltips(){}
  const std::string ntucs_tooltip = "This controls the edge length of the quadratic slice. The length is the number of unit cells times the unit cell length in {100},{010},{001}. So far it does not adapt to different unit cell length (periodicity length) in different orientations.";
